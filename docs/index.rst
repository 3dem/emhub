...
designed for operations of medium-sized CryoEM centers. It allows the creation of users and
resources (e.g. microscopes or other instruments). It also coordinates access to resources through
applications and bookings, providing full traceability and reporting of usage. Read move about
it in this :doc:`EMhub's Overview </user_manual/overview>`.
