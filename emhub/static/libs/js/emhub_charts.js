...
function create_hc_fscplot(containerId, fscSeries){
    Highcharts.chart(containerId, {
        ...
        yAxis: {
            ...
            max: 1.25,       
            plotLines: [
                { value: 0.5, dashStyle: 'Dash', color: '#999', width: 1 },
                { value: 0.143, dashStyle: 'Dash', color: '#999', width: 1 }
            ]
        },

        xAxis: {
            type: 'linear',
            title: { text: 'Resolution (Å)' },
            reversed: true
        },
        ...
        tooltip: {
            formatter: function () {
                return '<b>' + this.series.name + '</b><br/>' +
                    'Resolution: ' + Highcharts.numberFormat(this.point.x, 2) + ' Å<br/>' +
                    'FSC: ' + Highcharts.numberFormat(this.point.y, 3);
            }
        },
